...
const Navbar = () => {
  ...
  return (
    <div className="flex justify-between items-center h-24 max-w-[1240px] mx-6 md:mx-auto sm:mx-auto">
        ...
        {/* <div className={nav === false ? 'fixed left-0 top-0 w-[60%] h-full border-r bg-[#1E293B] ease-in-out duration-300' : 'fixed left-[-100%] ease-in-out duration-500' }>
            <div>
                <h1 className='flex w-full text-white text-5xl font-bold p-4'>Jesse<p className='text-[#00df9a]'>Dev</p></h1>
            </div>
                <ul className='flex'>
